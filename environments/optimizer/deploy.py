...
""")
    ...
    print("--- STDOUT ---")
    print(return_obj['stdout'].decode() if isinstance(return_obj['stdout'], bytes) else return_obj['stdout'])
    print("--- STDERR ---")
    print(return_obj['stderr'].decode() if isinstance(return_obj['stderr'], bytes) else return_obj['stderr'])
    print("--- CODE ---")
