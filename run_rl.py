...
env = StarMapCompressionEnv(
    data_path="C:/Users/boobs/Projects/space/Atropos/environments/hack0/starmap_compression/galaxy_subset.npy",
    views_path="C:/Users/boobs/Projects/space/Atropos/environments/hack0/starmap_compression/user_views.npy"
)
...
for step in range(num_steps):
    ...
    reward = -env.evaluate()['avg_data_size'] / 1000 + 5 * len(env.data) / len(env.original_data)
    total_points = sum(np.sum(np.sqrt(np.sum((env.data - v) ** 2, axis=1)) < env.view_radius) for v in env.views)
    metric = {
        "step": step + 1,
...
data = np.load("C:/Users/boobs/Projects/space/Atropos/environments/hack0/starmap_compression/galaxy_subset.npy")
views = np.load("C:/Users/boobs/Projects/space/Atropos/environments/hack0/starmap_compression/user_views.npy")
tree = cKDTree(data)
